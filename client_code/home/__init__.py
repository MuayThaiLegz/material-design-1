...
class home(homeTemplate):
    ...
    #     data, columns = anvil.server.call('fetch_collection_data', self.mongoConnect, self.selected_dataset, selected_collection)
    ...
    #     data_grid = DataGrid(show_header=True)
    #     data_gird.columns = [DataGridColumn(title=col, data_key=col) for col in columns])
